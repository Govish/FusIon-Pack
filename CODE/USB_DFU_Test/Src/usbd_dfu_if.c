...
//uhhhh I just found this on the internet somewhere
//code by forum user nichtgedacht
//http://www.openstm32.org/forumthread3245
uint16_t MEM_If_Erase_FS(uint32_t Add)
{
  ...
  //NbOfPages = ((FLASH_BANK1_END - USBD_DFU_APP_DEFAULT_ADD) / FLASH_PAGE_SIZE) + 1;
